...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2024 at 05:44 PM
...
INSERT INTO `tbl_sid` (`id`, `sid`, `userid`, `adminid`) VALUES
(4, 'asdfsgsfgdhcxbdzxch', NULL, 1),
(5, 'c6f856999a91b0f6', NULL, 2),
(6, 'salals', 1, NULL),
(7, '983ca8da85863944', 3, NULL);
...
--
ALTER TABLE `tbl_answer`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'لیست پاسخ ها', AUTO_INCREMENT=92;
...
--
ALTER TABLE `tbl_question`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'لیست سوالات', AUTO_INCREMENT=75;

--
-- AUTO_INCREMENT for table `tbl_quiz`
--
ALTER TABLE `tbl_quiz`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'لیست آزمون ها', AUTO_INCREMENT=114;
...
--
ALTER TABLE `tbl_useranswer`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'لیست پاسخ های دانش آموزان به سوالات', AUTO_INCREMENT=14;
